#include "main.h"
/**
 * cd - function that handles the cd command
...
/**
 * env - function prints env variable
 * @args : command passed by the user
 ...
 * Return: exit command
 */
int exit(__attribute__((unused)) char **args)
{
        exit(98);
}

int history(__attribute__((unused)) char **args)
{
